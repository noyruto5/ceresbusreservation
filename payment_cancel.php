            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content" style="min-height: 500px; font-size: 1.1em">
                            <?php if ($reservation->payment_cancel()) {?>
                                <div>
                                    <h2>Your payment and reservation has been cancelled successfully.</h2>
                                    <br/>
