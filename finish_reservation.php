                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content" style="background-color: #FFFFCC;">
                            <div class="finish-res-content">
                                <?php $reservation->create(); ?>
                                <?php if (isset($reservation->input_warning)){ ?>
                                            <div class="alert alert-danger">
                                                <?php echo $reservation->input_warning; ?>
                                            </div>
                                    <?php } else if (isset($reservation->input_success)){
                                            echo $reservation->input_success;
                                        }
                                ?>
                            </div>
                        </div>
